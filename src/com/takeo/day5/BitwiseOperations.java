...
/*Bitwise operators have several use cases,particularly in scenarios that involve low-level programming,
...
public class BitwiseOperations {
    ...
    public static void main(String[] args) {
        ...
        int num = 16;
        int result6 = num >> 1; // Equivalent to num / 2, but faster  //right shift operator
